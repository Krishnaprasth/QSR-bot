...
def gpt_fallback(question: str) -> str:
    ...
    messages = [
        {"role": "system", "content": "You are a helpful performance analytics bot for a QSR chain. Answer based strictly on available data."},
        {"role": "user", "content": f"Sample of the dataset:\n{context_snippet}\n\nQuestion:\n{question}"}
    ]
